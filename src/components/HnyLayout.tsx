...
export const WHATSAPP_URL = "https://wa.me/447795008114";
export const CONSULT_URL = INSTAGRAM_URL; // deprecated — kept for back-compat, points to Instagram
export const DEPOSIT_URL = "https://wa.me/447795008114"; // deprecated — points to WhatsApp
