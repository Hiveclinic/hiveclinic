        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <Link to="/bookings?category=Dermaplaning" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-foreground text-background font-body text-sm tracking-widest uppercase hover:bg-accent transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              ...
              <p className="font-body text-sm text-muted-foreground leading-relaxed">
                Dermaplaning is suitable for most skin types, especially those with dull, dry, or rough skin. It's ideal as a pre-event treatment or as part of a regular skincare routine. Not recommended for active acne or very sensitive skin.
              </p>
            </div>
            <div>
