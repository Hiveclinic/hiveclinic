  ...
  try {
    ...
    if (emailType === "admin_new_booking") {
      ...
      html = wrap(`
        ...
        <p style="${pStyle}">A new booking has been confirmed:</p>
        <div style="${cardStyle}">
    ...
    if (emailType === "confirmation") {
      ...
      html = wrap(`
        <h2 style="${h2Style}">Your booking is confirmed</h2>
        <p style="${pStyle}">Hi ${booking.customer_name},</p>
        <p style="${pStyle}">Thank you for booking with Hive Clinic. Here are your appointment details:</p>
        <div style="${cardStyle}">
          <p style="margin:0 0 8px;font-size:14px;"><strong>Treatment:</strong> ${treatmentName}</p>
          <p style="margin:0 0 8px;font-size:14px;"><strong>Date:</strong> ${dateFormatted}</p>
          <p style="margin:0 0 8px;font-size:14px;"><strong>Time:</strong> ${timeFormatted}</p>
      ...
      html = wrap(`
        <h2 style="${h2Style}">Your appointment is tomorrow</h2>
        <p style="${pStyle}">Hi ${booking.customer_name},</p>
        <p style="${pStyle}">Just a friendly reminder that your appointment is tomorrow:</p>
        <div style="${cardStyle}">
      ...
      html = wrap(`
        <h2 style="${h2Style}">Your aftercare guide</h2>
        <p style="${pStyle}">Hi ${booking.customer_name},</p>
        <p style="${pStyle}">Thank you for visiting Hive Clinic today. Here are your aftercare instructions for ${treatmentName}:</p>
        <div style="${cardStyle}">
      ...
      html = wrap(`
        <h2 style="${h2Style}">Appointment Rescheduled</h2>
        <p style="${pStyle}">Hi ${booking.customer_name},</p>
      ...
      const adminHtml = wrap(`
        ...
        <p style="${pStyle}"><strong>${booking.customer_name}</strong> has rescheduled their appointment:</p>
        ...
        <p style="${pStyle}">Treatment: ${treatmentName}</p>
      ...
      const adminCancelHtml = wrap(`
        <h2 style="${h2Style}">Client Cancelled Booking</h2>
        <p style="${pStyle}"><strong>${booking.customer_name}</strong> has cancelled their appointment:</p>
    ...
    // Send admin a copy of client email for every standard type
    logStep("Sending admin copy", { subject });
    await sendEmail(ADMIN_EMAIL, `[Copy] ${subject}`, html);
