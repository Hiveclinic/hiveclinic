...
const treatments = [
  ...
  { name: "Large Area", desc: "Full abdomen, back rolls, hips, or thighs.", price: "£300" },
  { name: "Small Area Course (3 Sessions)", desc: "Course of 3 small area treatments for optimal results.", price: "£390" },
  { name: "Medium Area Course (3 Sessions)", desc: "Course of 3 medium area treatments.", price: "£540" },
  { name: "Large Area Course (3 Sessions)", desc: "Course of 3 large area treatments.", price: "£810" },
];
...
const faqs = [
  ...
  { q: "How much does fat dissolving cost in Manchester?", a: "Fat dissolving treatments at Hive Clinic start from £150 for a small area. Course packages of 3 sessions start from £390, offering significant savings." },
];
