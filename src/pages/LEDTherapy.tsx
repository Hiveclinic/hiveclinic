  ...
  <Layout>
    <section className="relative min-h-[70vh] flex items-center">
      <div className="absolute inset-0">
        <img src={gallery5} alt="LED light therapy Manchester" className="w-full h-full object-cover" />
    ...
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="aspect-[4/5] overflow-hidden"><img src={gallery3} alt="LED therapy results" className="w-full h-full object-cover" loading="lazy" /></div>
        </div>
      </div>
    </section>
