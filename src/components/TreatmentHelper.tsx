...
const recommendations: Record<string, Recommendation> = {
  ...
  "I have stubborn fat around my chin, stomach or thighs": {
    ...
    description: "Non-surgical fat reduction for chin, jawline, abdomen, flanks, and more. Permanent results with minimal downtime - the body contouring solution you've been looking for.",
